...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of tilt-dev/python_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = tilt-dev/python_client.Configuration(
    ...
    Note you can use the constants defined in the tilt-dev/python_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = tilt-dev/python_client.Configuration(
        signing_info = tilt-dev/python_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("tilt-dev/python_client")
