...
from tilt-dev/python-kubernetes.client.models.v1_owner_reference import V1OwnerReference  # noqa: E501
...
class TestV1OwnerReference(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_owner_reference.V1OwnerReference()  # noqa: E501
        if include_optional :
