...
from tilt-dev/python-kubernetes.client.api.custom_objects_api import CustomObjectsApi  # noqa: E501
...
class TestCustomObjectsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = tilt-dev/python-kubernetes.client.api.custom_objects_api.CustomObjectsApi()  # noqa: E501
