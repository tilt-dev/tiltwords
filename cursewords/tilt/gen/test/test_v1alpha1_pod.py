...
from tilt-dev/python-kubernetes.client.models.v1alpha1_pod import V1alpha1Pod  # noqa: E501
from tilt-dev/python-kubernetes.client.rest import ApiException

class TestV1alpha1Pod(unittest.TestCase):
    """V1alpha1Pod unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1alpha1_pod.V1alpha1Pod()  # noqa: E501
        if include_optional :
            return V1alpha1Pod(
                ancestor_uid = '0',
