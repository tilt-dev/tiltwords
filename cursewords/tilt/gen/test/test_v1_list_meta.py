...
from tilt-dev/python-kubernetes.client.models.v1_list_meta import V1ListMeta  # noqa: E501
...
class TestV1ListMeta(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_list_meta.V1ListMeta()  # noqa: E501
        if include_optional :
            return V1ListMeta(
                _continue = '0',
