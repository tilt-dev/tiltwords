...
from tilt-dev/python-kubernetes.client.models.v1alpha1_kubernetes_discovery_list import V1alpha1KubernetesDiscoveryList  # noqa: E501
from tilt-dev/python-kubernetes.client.rest import ApiException

class TestV1alpha1KubernetesDiscoveryList(unittest.TestCase):
    """V1alpha1KubernetesDiscoveryList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1KubernetesDiscoveryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = tilt-dev/python-kubernetes.client.models.v1alpha1_kubernetes_discovery_list.V1alpha1KubernetesDiscoveryList()  # noqa: E501
        if include_optional :
            return V1alpha1KubernetesDiscoveryList(
                api_version = '0',
                items = [
                    tilt-dev/python-kubernetes.client.models.v1alpha1/kubernetes_discovery.v1alpha1.KubernetesDiscovery(
                        api_version = '0',
                        kind = '0',
    ...
    def testV1alpha1KubernetesDiscoveryList(self):
        """Test V1alpha1KubernetesDiscoveryList"""
