...
from tilt-dev/python-kubernetes.client.models.v1_watch_event import V1WatchEvent  # noqa: E501
...
class TestV1WatchEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_watch_event.V1WatchEvent()  # noqa: E501
        if include_optional :
            return V1WatchEvent(
                object = None,
                type = '0'
