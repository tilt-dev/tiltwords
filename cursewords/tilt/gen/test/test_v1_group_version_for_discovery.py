...
from tilt-dev/python-kubernetes.client.models.v1_group_version_for_discovery import V1GroupVersionForDiscovery  # noqa: E501
...
class TestV1GroupVersionForDiscovery(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_group_version_for_discovery.V1GroupVersionForDiscovery()  # noqa: E501
        if include_optional :
