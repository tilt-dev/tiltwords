...
from tilt-dev/python-kubernetes.client.models.v1alpha1_cmd_list import V1alpha1CmdList  # noqa: E501
from tilt-dev/python-kubernetes.client.rest import ApiException

class TestV1alpha1CmdList(unittest.TestCase):
    """V1alpha1CmdList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1CmdList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = tilt-dev/python-kubernetes.client.models.v1alpha1_cmd_list.V1alpha1CmdList()  # noqa: E501
        if include_optional :
            return V1alpha1CmdList(
                api_version = '0',
                items = [
                    tilt-dev/python-kubernetes.client.models.v1alpha1/cmd.v1alpha1.Cmd(
                        api_version = '0',
                        kind = '0',
