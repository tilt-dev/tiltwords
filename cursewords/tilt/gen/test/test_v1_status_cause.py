...
from tilt-dev/python-kubernetes.client.models.v1_status_cause import V1StatusCause  # noqa: E501
...
class TestV1StatusCause(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_status_cause.V1StatusCause()  # noqa: E501
        if include_optional :
