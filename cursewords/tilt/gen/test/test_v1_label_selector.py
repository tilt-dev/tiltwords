...
from tilt-dev/python-kubernetes.client.models.v1_label_selector import V1LabelSelector  # noqa: E501
...
class TestV1LabelSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_label_selector.V1LabelSelector()  # noqa: E501
        if include_optional :
