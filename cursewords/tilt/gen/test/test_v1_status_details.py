...
from tilt-dev/python-kubernetes.client.models.v1_status_details import V1StatusDetails  # noqa: E501
...
class TestV1StatusDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_status_details.V1StatusDetails()  # noqa: E501
        if include_optional :
