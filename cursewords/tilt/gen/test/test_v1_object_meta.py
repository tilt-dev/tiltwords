...
from tilt-dev/python-kubernetes.client.models.v1_object_meta import V1ObjectMeta  # noqa: E501
...
class TestV1ObjectMeta(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_object_meta.V1ObjectMeta()  # noqa: E501
        if include_optional :
            return V1ObjectMeta(
                annotations = {
                    'key' : '0'
