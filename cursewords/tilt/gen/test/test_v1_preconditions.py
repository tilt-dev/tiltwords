...
from tilt-dev/python-kubernetes.client.models.v1_preconditions import V1Preconditions  # noqa: E501
...
class TestV1Preconditions(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tilt-dev/python-kubernetes.client.models.v1_preconditions.V1Preconditions()  # noqa: E501
        if include_optional :
